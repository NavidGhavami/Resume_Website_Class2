...
namespace Resume.Domain.Migrations
{
    ...
    [Migration("20250216162420_Create_ArticleCategory_and_Article_Entity")]
    partial class Create_ArticleCategory_and_Article_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resume.Domain.Entities.Blog.ArticleCategory", b =>
                {
                    ...
                    b.Property<string>("ArticleCategoryImage")
                        .HasMaxLength(350)
                        .HasColumnType("nvarchar(350)");
            ...
            modelBuilder.Entity("Resume.Domain.Entities.Skills.Skills", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Resume.Domain.Entities.Blog.Article", b =>
                {
                    b.HasOne("Resume.Domain.Entities.Blog.ArticleCategory", "ArticleCategory")
                        .WithMany("Articles")
